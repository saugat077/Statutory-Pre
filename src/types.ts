...
export const NAV_ITEMS: NavItem[] = [
  ...
  { id: 'smp',      code: 'SMP',  label: 'Maternity Pay',   color: '#d53880' },
  { id: 'spp',      code: 'SPP',  label: 'Paternity Pay',   color: '#1d70b8' },
  { id: 'sap',      code: 'SAP',  label: 'Adoption Pay',    color: '#f47738' },
  ...
  { id: 'ssp',      code: 'SSP',  label: 'Sick Pay',        color: '#00703c' },
